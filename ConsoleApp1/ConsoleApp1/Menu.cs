...
namespace Project
{
    ...
    internal class Menu
    {
        ...
        private void GetEventsOnDate()
        {
            ...
            {
                Console.WriteLine($"The events on {date}:");
        ...
        private Event CreateEvent(string eventType)
        {
            ...
            if (eventType == "show")
            {
                Event newEvent = CreateShow(eventLength, eventTime, eventHall);
                return newEvent;
            }
            else if (eventType == "concert")
            {
                Event newEvent = CreateConcert(eventLength, eventTime, eventHall);
                return newEvent;
            }
            else
            {
        ...
        private Event CreateConcert(double length, DateTime time, int hall)
        {
            ...
            Concert newConcert = new Concert(instrument, length, time, hall);
            return newConcert;
        }

        private Event CreateShow(double length, DateTime time, int hall)
        {
            Console.WriteLine("Enter title:");
            string eventTitle = Console.ReadLine();

            Show newShow = new Show(eventTitle, length, time, hall);
            return newShow;
        }
